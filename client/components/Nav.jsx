...
class Nav extends React.PureComponent {
    ...
    return (
      <ul className="nav__items-left">
        ...
        <li className={navDropdownState.file}>
          ...
          >
            <span className="nav__item-header">{this.props.t('ToolBar.File')}</span>
            ...
            {getConfig('UI_COLLECTIONS_ENABLED') &&
              ...
              <li className="nav__dropdown-item">
                <Link
                  ...
                  onClick={this.setDropdownForNone}
                >
                  {this.props.t('ToolBar.AddToCollection')}
                </Link>
              </li>}
        ...
        <li className={navDropdownState.edit}>
          ...
          >
            <span className="nav__item-header">{this.props.t('ToolBar.Edit')}</span>
            <TriangleIcon className="nav__item-header-triangle" focusable="false" aria-hidden="true" />
          </button>
          <ul className="nav__dropdown" >
            <li className="nav__dropdown-item">
            ...
            <li className="nav__dropdown-item">
              <button
                ...
                onBlur={this.handleBlur}
              >
                {this.props.t('ToolBar.FindPrevious')}
                <span className="nav__keyboard-shortcut">{'\u21E7'}+{metaKeyName}+G</span>
              </button>
            </li>
          </ul>
        ...
        <li className={navDropdownState.sketch}>
          ...
          >
            <span className="nav__item-header">{this.props.t('ToolBar.Sketch')}</span>
            <TriangleIcon className="nav__item-header-triangle" focusable="false" aria-hidden="true" />
          </button>
          <ul className="nav__dropdown">
            <li className="nav__dropdown-item">
            ...
            <li className="nav__dropdown-item">
              <button
                ...
                onBlur={this.handleBlur}
              >
                {this.props.t('ToolBar.AddFolder')}
              </button>
            </li>
            <li className="nav__dropdown-item">
              <button
        ...
        <li className={navDropdownState.help}>
          ...
          >
            <span className="nav__item-header">{this.props.t('ToolBar.Help')}</span>
            <TriangleIcon className="nav__item-header-triangle" focusable="false" aria-hidden="true" />
          </button>
          <ul className="nav__dropdown">
            <li className="nav__dropdown-item">
              ...
              >
                {this.props.t('ToolBar.KeyboardShortcuts')}
              </button>
            </li>
            <li className="nav__dropdown-item">
              <a
                ...
                onBlur={this.handleBlur}
                onClick={this.setDropdownForNone}
              >{this.props.t('ToolBar.Reference')}
              </a>
            </li>
            <li className="nav__dropdown-item">
              <Link
    ...
    return (
      <ul className="nav__items-right" title="user-menu">
        <li className={navDropdownState.lang}>
          ...
          >
            <span className="nav__item-header"> {this.props.t('Shortcut.Lang')}</span>
            <TriangleIcon className="nav__item-header-triangle" focusable="false" aria-hidden="true" />
          </button>
          <ul className="nav__dropdown">
  ...
  renderAuthenticatedUserMenu(navDropdownState) {
    return (
      <ul className="nav__items-right" title="user-menu">
        <li className="nav__item">
          <span>{this.props.t('Login.Hello')}, {this.props.user.username}!</span>
        </li>
            ...
            {getConfig('UI_COLLECTIONS_ENABLED') &&
              <li className="nav__dropdown-item">
                <Link
                  ...
                  onClick={this.setDropdownForNone}
                >
                  {this.props.t('Login.MyCollections')}
                </Link>
              </li>
            }
            <li className="nav__dropdown-item">
...
export default withTranslation(['ToolBar', 'About', 'Login', 'Shortcut', 'Preferences'])(withRouter(connect(mapStateToProps, mapDispatchToProps)(Nav)));
